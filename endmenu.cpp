...
//结束画面
EndMenu::EndMenu(QStackedWidget *parent)
    : QWidget(parent)
{
    //设置名称和尺寸
    ...
    connect(backButton,&QPushButton::clicked,parent,[=]{parent->setCurrentIndex(0);});//按下按钮，跳转到stack的第1页

}

void EndMenu::setBkg(int x_)
{
    x=x_;
}
