    ...
    : QWidget{parent}
{
    ...
    connect(startGameButton,&QPushButton::clicked,parent,[=]{parent->setCurrentIndex(1);});//按下按钮，跳转到stack的第1页
    ...
    connect(exitButton,&QPushButton::clicked,parent->parentWidget(),&QWidget::close);//按下按钮，关闭mainmenu；从而关闭整个程序
